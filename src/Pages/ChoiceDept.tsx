      ...
      <Chageui>
          ...
          {departArr &&
            departArr.map((val, i) => (
              <Box
                ...
                key={val.access_token}
                sx={{
                  backgroundColor: !val.is_active && "rgb(240, 240, 240)",
                  ...
                  gap: "20px",
                  padding: "20px",
                  cursor: val.is_active ? "pointer" : "not-allowed",
                  alignItems: "center",
                  opacity: val.is_active ? 1 : 0.5,
                }}
              >
                <Box sx={{ display: "flex", gap: "20px" }}>
                  <img
                    src={val.image_base_url + val.profile.image}
                    style={{
                      width: "40px",
                      height: "40px",
                      borderRadius: "50%",
                  ...
                  <Box sx={{ display: "flex", flexDirection: "column" }}>
                    ...
                    <Typography>{val.profile.email}</Typography>
                  </Box>
                </Box>
                ...
                <img
                  ...
                  style={{
                    width: "20px",
                    height: "17px",
                    opacity: idp == val.profile.id && val.is_active ? 1 : 0,
                  }}
                />
              </Box>
            ))}
        ...
        >
          <Buttonmy
            ...
            disabile={idp ? false : true}
            text={"Next"}
            width={"20%"}
            bgcolor={idp ? "#A2907C" : "#CCCCCC"}
          />
        </Stack>
      </Chageui>
      <ToastContainer />
